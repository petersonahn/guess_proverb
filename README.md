...
| 기능 | 파일 위치 | 설명 |
|------|-----------|------|
| 하이브리드 난이도 분석| `app/includes/analyzer.py` | 사용 빈도(60%) + 언어적 복잡성(40%) 알고리즘 |
| 유사도 측정 | `app/main.py` (라인 235-267) | KR-SBERT 기반 코사인 유사도 |
...
### 💡 **기존 방식의 한계점**
기존 속담 게임들의 난이도 측정 방식은 다음과 같은 문제점이 있었습니다:
