...
class ProverbDifficultyAnalyzer:
    ...
    def __init__(self):
        ...
        print(f"🔬 분석 방식: 사용 빈도 중심 (사용자 핵심 기여: AI 사용빈도 60% + 언어적복잡성 40%)")
